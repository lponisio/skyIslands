...
##                                   temp.id= c()),
    ...
    Halictus_ligatus_f= list(Genus="Halictus", SubGenus ="Odontalictus",
                             ...
                             Sex="f", Author = "Say",
                             Determiner = "J.L. Neff",
                             temp.id= c(32774, 36677, 37767, 37695,
                                        33577, 33121, 34319)),
    ...
    Halictus_tripartitus_f= list(Genus="Halictus",
                                 ...
                                 temp.id= c(31109,
                                            36742,
                                            33621,31913,31128,31109,33621,35742,35484,35617,35623,35639,35644,35649,35650,35657,35661,35671,35675,35677,35680,35689,35690,
                                            35983,35747,35883,36248,36330,36052,36069
                                            )),
