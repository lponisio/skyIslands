...
##                               temp.id= c()),
    ...
    Megachile_frigida_f = list(Genus="Megachile",
                               ...
                               Sex="f", Author = "Smith",
                               Determiner = "J.L. Neff",
                               temp.id=  c(36622, 36848, 37875, 37798, 37908, 37909, 37698, 37958, 37796, 37794, 37795, 37766, 37740, 37605, 37671, 37584, 37675, 37679, 36840, 36644, 36538, 36692, 36763, 36797, 36595, 37680)),
