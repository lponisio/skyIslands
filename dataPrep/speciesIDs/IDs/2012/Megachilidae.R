...
sp.ids <- list(
  ...
  Megachile_frigida_f = list(Genus="Megachile", SubGenus ="Xanthosarus",
    ...
    temp.id=  c("PL_080912_154", "MM_080112_214", "PL_081012_80",
                "PL_081012_11",  "PL_081012_81", "PL_081112_81",
                "PL_081112_129", "PL_081112_176", "PL_081012_249",
                "PL_080912_114", "PL_081212_9", "PL_081212_122",
                "PL_081112_151", "PL_081212_141", "PL_081112_80",
                "PL_081212_142", "PL_081312_165", "MM_080212_304",
                "PL_081212_41", "PL_081312_29", "PL_081312_136",
                "PL_081212_11", "PL_081312_147", "PL_081212_10",
                "PL_081212_121", "JC_071612_112", "JC_071712_113",
                "JC_071212_32", "JC_071712_156", "JC_071212_76",
                "JC_071612_98", "JC_071712_110", "JC_071712_155",
                "MM_080212_181")),
   ...
   Megachile_relativa = list(Genus="Megachile",
    ...
    Determiner="J.S. Ascher", temp.id= c("JC_071712_60", "JC_071712_160")),

  Megachile_policaris = list(Genus="Megachile",
    SubGenus ="Sayapis", Species="policaris",
    SubSpecies="", Sex="m", Author = "Say",
    Determiner="J.S. Ascher", temp.id= c("PL_081312_95")),

   Megachile_inimica_sayi  = list(Genus="Megachile",
    SubGenus ="Sayapis", Species="inimica",
    SubSpecies="sayi", Sex="m", Author = "Cresson",
    Determiner="J.S. Ascher", temp.id= c("PL_081112_210")),
