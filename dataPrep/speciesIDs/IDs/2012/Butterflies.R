...
sp.ids <- list(
  ...
  Vanessa_cardui = list(Genus = "Vanessa", SubGenus="", Species =
    ...
    "Nymphalidae", Determiner="L.Ponisio", temp.id = c("JC_071612_2", "MM_080212_324",
    ...
    "MM_080112_126B", "PL_081012_329", "MM_080112_249",
  ...
  Battus_philenor = list(Genus = "Battus", SubGenus="", Species =
    ...
    = "Papilionidae", Determiner="L.Ponisio", temp.id = c("PL_081212_307", "PL_081212_306",
  ...
  Limenitis_bredowii = list(Genus = "Limenitis", SubGenus="", Species
    ...
    = "Nymphalidae", Determiner="L.Ponisio", temp.id = c("CH_081812_20", "CH_082012_192",
  ...
  Colias_eurytheme = list(Genus = "Colias", SubGenus="", Species = "eurytheme",
    ...
    "Pieridae", Determiner="L.Ponisio", temp.id = c("SC_072712_265",
  ...
  Euptoierta_claudia = list(Genus = "Euptoierta", SubGenus="", Species
    ...
    = "Nymphalidae", Determiner="L.Ponisio", temp.id = c("CH_082012_185", "CH_082112_185",
  ...
  Vanessa_carye_annabella = list(Genus = "Vanessa", SubGenus="",
    ...
    "Field", Family = "Nymphalidae", Determiner="L.Ponisio", temp.id = c("PL_081212_309",
  ...
  Vanessa_atlanta = list(Genus = "Vanessa", SubGenus="", Species =
    ...
    = "Nymphalidae", Determiner="L.Ponisio", temp.id = c("CH_082012_167")),

  Vanessa_virginiensis = list(Genus = "Vanessa", SubGenus="", Species =
    "virginiensis", SubSpecies = "", Sex = "", Author = "Drury",
    Family = "Nymphalidae", Determiner="L.Ponisio", temp.id =c("JC_071412_24",
  ...
  Papilio_polyxenes = list(Genus = "Papilio", SubGenus="",Species =
    ...
    Family = "Papilionidae", Determiner="L.Ponisio", temp.id = c("PL_080912_352",
  ...
  Pontia_protodice = list(Genus = "Pontia",  SubGenus="",Species = "protodice",
    ...
    = "Pieridae", Determiner="L.Ponisio", temp.id = c("JC_071612_13", "JC_071512_10",
  ...
  Nathalis_iole = list(Genus = "Nathalis", SubGenus="",Species =
    ...
    "Pieridae", Determiner="L.Ponisio", temp.id = c("MM_080212_320", "MM_080212_323",
  ...
  Eurema_nicippe = list(Genus = "Eurema", SubGenus="",Species =
    ...
    "Pieridae", Determiner="L.Ponisio", temp.id = c("PL_081212_295", "PL_081312_275",
  ...
  Plebejus_acmon = list(Genus = "Plebejus", SubGenus="", Species =
    ...
    "Lycaenidae", Determiner="L.Ponisio", temp.id =c("SC_072712_270", "SC_072612_285",
  ...
  Ministrymon_leda = list(Genus = "Ministrymon", SubGenus="", Species
    ...
    "Lycaenidae", Determiner="L.Ponisio", temp.id =c("SC_072012_330")),

  Strymon_melinus = list(Genus = "Strymon", SubGenus="", Species =
    "melinus", SubSpecies = "", Sex = "", Author = "Hubner", Family =
    "Lycaenidae", Determiner="L.Ponisio", temp.id =c("MM_073112_126", "JC_071712_7",
  ...
  Celastrina_argiolus_ladon = list(Genus = "Celastrina", SubGenus="",
    ...
    "Cramer", Family = "Lycaenidae", Determiner="L.Ponisio", temp.id = c("PL_081212_289",
    "MM_080312_213")),
  ...
  Ochlodes_snowi = list(Genus = "Ochlodes", SubGenus="",Species =
    ...
    "Hesperiidae", Determiner="L.Ponisio", temp.id = c("PL_081212_248", "PL_081312_249")),
  ...
  Hemiargus_isola = list(Genus = "Hemiargus", SubGenus="", Species = "isola",
    ...
    Determiner="L.Ponisio", temp.id = c("SC_072812_106", "SC_072912_122", "PL_081312_241",
  ...
  Garisma_garita = list(Genus = "Garisma", SubGenus="",Species =
    ...
    "Hesperiidae", Determiner="L.Ponisio", temp.id = c("MM_080112_245", "MM_080112_246",
  ...
  Hemiargus_ceraunus = list(Genus = "Hemiargus", SubGenus="", Species
    ...
    Family = "Lycaenidae", Determiner="L.Ponisio", temp.id = c("CH_082112_207")),

  Polites_draco = list(Genus = "Polites", SubGenus="", Species = "draco",
    SubSpecies = "", Sex = "", Author = "Edwards", Family =
    "Hesperiidae", Determiner="L.Ponisio", temp.id = c("JC_071612_143")),
  ...
  Poanes_zabulon_taxiles = list(Genus = "Poanes", SubGenus="", Species
    ...
    Family = "Hesperiidae", Determiner="L.Ponisio", temp.id = c("CH_082212_39")),
  ...
  Thorybes_pylades = list(Genus = "Thorybes", SubGenus="", Species =
   ...
   Hyles_lineata = list(Genus = "Hyles", SubGenus="",Species =
    ...
    "Sphingidae", Determiner="L.C. Ponisio", temp.id = c("PL_081312_257","PL_081312_258",
                                                         "PL_081312_259","PL_081312_260","PL_081312_265",
                                                         "PL_081312_266","CH_081812_7","CH_082012_182B",
                                                         "CH_082112_190","CH_082112_191","CH_082112_192",
                                                         "CH_082112_193","CH_082112_194","CH_082112_195",
                                                         "CH_082112_196","CH_082112_197",
