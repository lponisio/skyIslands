...
sp.ids <- list(
    ...
    Melissodes_confusa= list(Genus="Melissodes",
     ...
     Melissodes_confusa_m= list(Genus="Melissodes",
                             SubGenus="Eumelissodes",
                             Species="confusa",
                             SubSpecies="", Sex="m",
                             Author = "Cresson",
    ...
    Apis_mellifera_f = list(Genus="Apis", SubGenus = "Apis",
                            ...
                            temp.id= c(30654,30655,30656,30657,30658,
                                       ...
                                       32808,32809,32833,32875,32877,32878,
                                       32879,33045,33046,33047,33048,
                                       33049,33133,33134,33135,33136,
                                       33137,33138,33139,33140,33180,
                                       33181,33182,33183,33184,33185,
                                       33186,33187,33188,33189,33190,
                                       33226,33227,33228,33229,33230,
                                       33231,33232,33233,33234,33235,
                                       33236,33237,33238,33239,33318,
                                       33319,33320,33321,33322,33323,
                                       33324,33325,33326,33327,33328,
                                       33392,33393,33394,33395,33396,
                                       33546,33547,33697,33698,33699,
                                       33738,33739,33740,33741,33742,
                                       33743,33744,33745,33746,33747,
                                       33778,33779,33780,33781,33782,
                                       33783,33784,33785,33786,33787,
                                       33788,33789,33790,33791,33792,
                                       33793,33794,33795,33796,33797,
                                       33798,33799,33800,33801,33802,
                                       33803,33804,33805,33806,33807,
                                       33808,33809,33810,33811,33812,
                                       33813,33814,33815,33816,33817,
                                       33818,33819,33820,33821,33822,
                                       33823,33824,33825,33826,33827,
                                       33828,33829,33830,33831,33832,
                                       33833,33834,33835,33894,33895,
                                       33896,33897,33898,33899,33900,
                                       33901,33902,33903,33904,33905,
                                       33906,33907,33908,33909,34392,
                                       33910,33911,33912,33913,33914,
                                       33915,33916,33917,33918,33919,
                                       33920,33921,33922,33923,33924,
                                       34004,34005,34061,34104,34376,
                                       34393,34394,34395,34254,34255,
                                       34256,34257,34258,34310,34311,
 ...
 Bombus_fervidus_f = list(Genus = "Bombus", SubGenus="Thoracobombus",
    ...
    Bombus_centralis_f = list(Genus = "Bombus",
                              ...
                              temp.id = c(30735, 30733, 30732, 30739,
                                          ...
                                          30756, 30757, 30745, 30787,
                                          30788, 30789, 30790, 30857,
                                          30858, 30661, 30662, 30866,
                                          30869, 30870, 30877, 30882,
                                          30883, 30885, 30887, 30888,
                                          30889, 30891, 30893, 30894,
    ...
    Bombus_huntii_f = list(Genus = "Bombus",
                           ...
                           temp.id =
                               c(30734, 30736, 30737, 30744, 30746, 
                                 ...
                                 31703, 31835, 31847, 31848, 31849, 
                                 31850, 31851, 31854, 31856, 31858,
                                 31861, 31862, 31948, 31949, 
                                 31950, 31951, 31952, 31953, 31957,
                                 31958, 31960, 31964, 31967, 31970, 
                                 31971, 31972, 31973, 31975, 31976, 
                                 31983, 31989, 31990, 31991, 31992, 
                                 31993, 31994, 31995, 31996, 32001, 
                                 32004, 32006, 32007, 32008, 32010, 
                                 32014, 32015, 32016, 32018, 32021, 
                                 32023, 32024, 32026, 32027, 32032, 
                                 32036, 32037, 32038, 32185, 32188, 
                                 32189, 32190, 32191, 32194, 32198, 
                                 32199, 32201, 32202, 32206, 32208, 
                                 32209, 32211, 32215, 32224, 32227, 
                                 32228, 32230, 32232, 32234, 32242, 
                                 32243, 32247, 32253, 32254, 32256, 32258, 32259,
                                 32261, 32262, 32858, 33417, 33422, 
                                 33436, 33439, 34385, 34391, 33570 
    ...
    Bombus_bifarius_f = list(Genus = "Bombus",
                             ...
                             temp.id =
                                 c(31197, 31175, 31176, 31180, 31183,
                                   ...
                                   31344, 31347, 31460,31463,32359,32360,
                                   32362,32364,32384,32480,32496,32498,
                                   32504,32508,32514,32645,32486,32478,
                                  32475,32358,32353,32505,32361,32357,32368,
                                   32371,32372,32376,32377,32378,32380,32382,
                                   32383,32469,32470,32472,34274,32476,32479,
                                   32482,32487,32488,32491,32493,32494,32497,
                                   32501,32503,32510,32513,32515,32516,32517,
                                  32525,32633,32638,32640,32643,32644,32647,32649,
                                  32651,32654,32656,32657,32658,32659,32660,31464)),
