...
sp.ids <- list(
    ...
    Pseudopanurgus_albitarsis_m= list(Genus="Pseudopanurgus", SubGenus ="",
       ...
       Panurginus_cressoniellus_f= list(Genus="Panurginus", SubGenus ="",
                                      ...
                                      Determiner="J.L. Neff",
                                      temp.id= c(31248, 31229, 32712, 31238, 31246,
                                                31255, 31257, 33111, 31373, 31380,
                                                32669, 32670, 32671, 32672, 32702,
                                                32703, 32696, 32693, 32697, 32691,
                                                32694, 32690, 32689, 32686, 32683,
                                                32681, 32678, 32677, 32673, 31215, 
                                                31214, 31394, 31395, 31393, 31391,
                                                31390, 31388, 31387, 31399, 31381,
                                                31476, 31400, 31403, 31404, 31405, 
                                                31406, 31413, 31417, 31418, 31421,
                                                31474, 31472, 31482, 32553, 32561,
                                                32542, 32565, 32566, 32576, 32578,
                                                32582, 32588, 32586, 32589, 32591,
                                                32594, 32596, 32598, 32568, 32600,
                                                32605, 32606, 32607, 32609, 32602,
                                                32611, 32549, 32666, 32550, 32548,
                                                32546, 32544, 32416, 32537, 32536,
                                                32534, 32411, 32533, 32540, 31233,
                                                32405, 32391, 32392, 32393, 32399,
                                                32407, 32402, 32612, 31398)),
