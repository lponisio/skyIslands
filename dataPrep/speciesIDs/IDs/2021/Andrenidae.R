...
sp.ids <- list(
    ...
    Protandrena_citripes_m= list(Genus="Protandrena", SubGenus ="Pterosarus",
                                  Species="citripes",
                                  SubSpecies="",
                                  Sex="m", Author = "Ashmead",
                                  Determiner="J.L. Neff",
                                  temp.id= c(35613)),
  ...
  Protandrena_sp= list(Genus="Protandrena", SubGenus ="",
    ...
    Andrena_apacheorum_f= list(Genus="Andrena",
                               ...
                               temp.id= c(31370, 31590, 31587, 31671,
                                          31669, 31670, 31531, 33058,
                                          31222, 32286, 33146, 30644,
                                          33148, 33147, 33157, 33335,
                                          33382, 33939, 33940, 33944,
                                          33946, 33947, 33334, 31244,
                                          30931, 31374, 32287, 31920,
                                          31897, 31903, 32289, 32529,
                                          31228, 32572, 31219, 31220,
                                          31223, 31225, 31367, 31371,
                                          31386)),
