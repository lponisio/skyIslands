...
sp.ids <- list(
  ...
  Vanessa_cardui = list(Genus = "Vanessa", SubGenus="", Species =
    ...
    "Nymphalidae", Determiner="A. Santillana", temp.id = c(38597)),
  ...
  Colias_eurytheme = list(Genus = "Colias", SubGenus="", Species = "eurytheme",
    ...
    "Pieridae", Determiner="J.F. Zorn", temp.id = c(36341,36345,36363,36364,36365,36378,36381,36398,36401,36402,36404,38406,38464,38472,38495,38499,38500,38524,38529,
                                                     38531,38537,38545,38546,38575,38576,38579,38598,38599,38600,38601,38602,38603,38642,38645,38662,38778,38878,39013,
                                                     39016,39052)),
  ...
  Pontia_protodice = list(Genus = "Pontia",  SubGenus="",Species = "protodice",
    ...
    "Lycaenidae", Determiner="A. Santillana", temp.id =c(38460)),
     ...
     Echinargus_isola = list(Genus = "Echinargus", SubGenus="", Species =
    "isola", SubSpecies = "", Sex = "", Author = "Reakirt", Family =
    "Lycaenidae", Determiner="A. Santillana", temp.id =c(39014,39014,39025,39027,39028,39029,39030,39031,38452,38516,38454,38459,38474,38483,39066,39073,
