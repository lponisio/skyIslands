...
## run full model
fit.microbe2 <- brm(bform2 , spec.net,
                  cores=ncores,
                  iter = 10000,
                  chains =1,
                  thin=1,
...
write.ms.table(fit.microbe2, "full_microbe2")
r2loo2 <- loo_R2(fit.microbe2)
r22 <- rstantools::bayes_R2(fit.microbe2)
save(fit.microbe2, spec.net, r22, r2loo2,
